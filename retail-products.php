...
try {
    ...
    //Prepare Statement operation for the PDO object($conn) abstraction database api layer
    $stmt = $conn->prepare($sql);
    
    //Execute Statement with data returned in database format
    $stmt->execute();
...
<body>
    ...
    <section>
        ...
        <!--
            if fetch keyword is used it Grabs the next row of data from database into an associative array
    if fetchAll keyword is used it Grabs all rows from query and turns into an accociative array
        -->
        <?php
        ...
        <div class="productBlock">
            ...
            ?>
            <p class="productInventory <?php echo " productLowInventory"; ?> "> 
            <?php 
                    }
